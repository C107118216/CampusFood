...
//                                bundle.putSerializable("product_name", order_name_List.get(i));
                                /* 當到陣列最後一筆時計算總花費 */
...
//            Integer count = 0;
            ...
            public void onClick(View v) {
                ...
                // 要做的事寫在這裡
//                Toast.makeText(getContext(), String.valueOf(total_cost), Toast.LENGTH_LONG)
//                        .show();
...
//                                Toast.makeText(getContext(), String.valueOf(order_name_List.get(idx)) + " X " + String.valueOf(order_count_List.get(idx)) + "；總花費：" + total_cost, Toast.LENGTH_LONG)
//                                        .show();
                            }
                        }
                        return true;
